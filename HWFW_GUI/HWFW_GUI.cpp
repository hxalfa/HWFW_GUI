...
//
//   Purpose: Save instance handle and create main window
//
//   Notes: 
//
...
void OpenFirmware(LPCWSTR lpPath)
{
  ...
  {
    SetStatus(L"Failed to update the view! Error code:[%d]", nResult);
    return ;
  }
