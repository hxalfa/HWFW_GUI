...
static void ListFileHeader(HWND hListView)
{
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"HeaderCRC32      #  Header CRC32  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"ItemCount        #  Software Information Count  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"ItemSize         #  Software information size  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  // Auto-fit all 3 columns to their content and header text.
  for (int i = 0; i < 3; i++)
  {
...
static void ListProductInfo(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 96, 0, L"Identification");
  ListView_AddColumn(hListView, 512, 1, L"Matching product");
...
void ListItemInfo(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 128, 0, L"Offset");
  ListView_AddColumn(hListView, 56, 1, L"Id");
  ListView_AddColumn(hListView, 304, 2, L"Path");
  ListView_AddColumn(hListView, 112, 3, L"Strategy");
  ListView_AddColumn(hListView, 112, 4, L"CRC32");
#if LV_CFG_SHOW_DATAINFO
  ListView_AddColumn(hListView, 100, 5, L"Data offset");
  ListView_AddColumn(hListView, 200, 6, L"Data size");
  ...
  // Auto-fit all columns based on the compile-time configuration.
#if LV_CFG_SHOW_DATAINFO
